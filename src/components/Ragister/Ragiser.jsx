...
const Ragiser = () => {
    ...
    return (
        <div className='max-w-lg mx-auto'>
            <h1 className='text-5xl font-bold mt-10 mb-14'>Register</h1>
            <form onSubmit={handleRegister}>
                ...
                <button className="btn btn-accent w-full my-6 text-white text-xl">Login</button>
            </form>
